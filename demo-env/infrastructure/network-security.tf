...
# Justification: The change allows unrestricted access to port 8080, which was previously not permitted. This compromises the confidentiality and integrity of the system by potentially exposing sensitive GxP data to u
